<div class="my-4 page-header-breadcrumb d-flex align-items-center justify-content-between flex-wrap gap-2">
    <div>
        <h1 class="page-title fw-medium fs-18 mb-2">Novo Imóvel</h1>
...
<div class="col-md-12">
    ...
    <div class="row mb-3">
        <div class="col-md-2">
            <label class="form-label" for="pessoa.cpf">CPF do proprietário</label>
            <?= $this->Form->control('pessoa.cpf', ['label' => false, 'class' => 'form-control']) ?>
        </div>
        <div class="col-md-4">
            <label class="form-label" for="pessoa.nome">Nome do proprietário</label>
            <?= $this->Form->control('pessoa.nome', ['label' => false, 'class' => 'form-control', "required" => true ]) ?>
        </div>
        <div class="col-md-3">
            <label class="form-label" for="pessoa.email">E-mail do proprietário</label>
            <?= $this->Form->control('pessoa.email', ['label' => false, 'class' => 'form-control', "required" => true ]) ?>
        </div>
        <div class="col-md-3">
            <label class="form-label" for="pessoa.telefone">Whatsapp do proprietário</label>
            <?= $this->Form->control('pessoa.telefone', ['label' => false, 'class' => 'form-control', "required" => true ]) ?>
        </div>
    </div>
    <div class="card">
        <div class="card-body">
            <div class="row mb-3">
                <div class="mb-3 col-md-3">
                    ...
                    <?= $this->Form->select('tipo_imovel_id', $tipos, ['class' => 'form-control']) ?>
                </div>
                <div class="col-md-9">
            ...
            <div class="row">
                <div class="mb-3 col-md-3">
                    <label class="form-label" for="tipo-imovel-id">Categoria</label>
                    <?= $this->Form->select('categoria_id', $categorias, ['class' => 'form-control']) ?>
                </div>
                <div class="mb-3 col-md-3">
            ...
            <div class="row">
                ...
                <div class="mb-3 col-md-3">
                    <label class="form-label" for="vaga_garagem">Vaga Garagem</label>
            ...
            <div class="row">
                ...
                <div class="mb-3 mt-1 pt-4 col-md-3">
                    <label for="financia" class="form-label">
                        <input type="checkbox" class="form-check-input" name="financia" id="financia" value="1">
    ...
    <div class="row">
        ...
        <div class="mb-3 mt-1 pt-4 col-md-2">
            <label for="comissao-permanente" class="form-label">
                <input type="checkbox" class="form-check-input" name="comissao_permanente" id="comissao-permanente" value="1">
    ...
    <div class="row">
        <div class="mb-3 mt-1 pt-4 col-md-2">
            <label for="exclusividade" class="form-label">
        ...
        <div class="mb-3 mt-1 pt-4 col-md-2">
            <label for="parceiria" class="form-label pt-4 mt-2">
                <input type="checkbox" class="form-check-input me-1" name="parceiria" id="parceiria" value="1">
